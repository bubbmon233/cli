	...
	Execute: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		default: // "table"
			...
			if mailbox != "me" {
				...
				fmt.Fprintln(runtime.IO().ErrOut, "tip: read full content: single message use mail +message --mailbox "+quotedMailbox+" --message-id <id>; multiple messages use mail +messages --mailbox "+quotedMailbox+" --message-ids <id1,id2,...>")
			} else {
