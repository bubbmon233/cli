...
var MailReply = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Additional To address(es). Repeat the flag or separate multiple addresses with commas (appended to original sender's address)."},
