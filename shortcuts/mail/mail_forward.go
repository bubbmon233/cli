...
var MailForward = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "attach", Type: "string_array", Desc: "Attachment file path(s), appended after original attachments (relative path only). Repeat the flag or separate multiple paths with commas."},
