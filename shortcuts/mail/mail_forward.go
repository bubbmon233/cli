...
var MailForward = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Recipient email address. Repeat --to once per recipient. Display-name format is supported."},
		...
		{Name: "cc", Type: "string_array", Desc: "CC email address. Repeat --cc once per recipient. Display-name format is supported."},
		{Name: "bcc", Type: "string_array", Desc: "BCC email address. Repeat --bcc once per recipient. Display-name format is supported."},
		{Name: "plain-text", Type: "bool", Desc: "Force plain-text mode, ignoring all HTML auto-detection. Cannot be used with --inline."},
		{Name: "attach", Type: "string_array", Desc: "Attachment file path, appended after original attachments (relative path only). Repeat --attach once per file; quote paths with spaces, parentheses, or non-ASCII characters."},
